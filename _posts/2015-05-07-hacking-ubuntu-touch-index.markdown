---
layout: post
title:  "Hacking Ubuntu Touch: Index"
date:   2015-05-07 20:30:00
categories: Ubuntu Touch
---


I've written a series on the internals of Ubuntu Touch and how to hack the bq Aquaris E4.5 Ubuntu Edition and Meizu MX4 Ubuntu Edition production devices. This page lists all articles and will be updated every time I publish something.

* [Hacking the bq, Part 1: Bootloader, Fastboot and Recovery]({% post_url 2015-05-04-hacking-the-bq-part-1-bootloader-fastboot-recovery %})

* [Hacking the bq, Part 2: Factory Mode]({% post_url 2015-05-04-hacking-the-bq-part-2-factory-mode %})

* [Hacking Ubuntu Touch, Part 1: ubuntu-device-flash]({% post_url 2015-05-05-hacking-ubuntu-touch-part-1-ubuntu-device-flash %})

* [Hacking Ubuntu Touch, Part 2: Devices and Images]({% post_url 2015-05-06-hacking-ubuntu-touch-part-2-devices-and-images %})
...
* [MediaTek details: SoC startup]({% post_url 2015-07-02-mediatek-details-soc-startup %})
...
* [Hacking Ubuntu Touch, Part 8: Fastboot]({% post_url 2015-07-04-hacking-ubuntu-touch-part-8-fastboot %})
