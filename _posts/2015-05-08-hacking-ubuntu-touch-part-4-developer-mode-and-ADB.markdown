...
The Daemon and Server talk to each other in a message-based binary wire protocol which is documented [here][aosp-adb-protocol-txt].
...
1. Server and Daemon send each other `CONNECT` messages.
