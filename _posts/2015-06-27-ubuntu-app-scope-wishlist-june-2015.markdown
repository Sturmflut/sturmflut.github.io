...
*This is an update to the [last post]({% post_url 2015-05-31-ubuntu-touch-app-wishlist-may-2015 %}) and has again been heavily extended. Thanks to all the people on the internet who came up with additions, updates and corrections. You know who you are!*
...
- [100 Balls][100balls-appexplorer]

- [2048][2048-appexplorer]

- [Akari][akari-appexplorer], a logic puzzle game.

- [Blabble][blabble-appexplorer], a word puzzle game.

- [ChessBoard][chessboard-appexplorer]

- (*NEW*) [Connect 4][connect4-appexplorer]
...
- (*NEW*) [Don't crash][dontcrash-appexplorer], avoid the other cars and don't crash!

- [Dotty][dotty-appexplorer]

- [Dropping Letters][droppingletters-appexplorer], a combination between Tetris and a word puzzle.

- [Euchre][euchre-launchpad], [Pairs][pairs-launchpad] and [Blackjack][blackjack-appexplorer], card games.

- [Falling Blocks][fallingblocks-appexplorer], a Tetris clone.

- [Flood It][flood-it-appexplorer], a clone of the addictive Android game.

- [Keytar Hero][keytarhero-appexplorer], a clone of Guitar Hero.

- (*NEW*) [Logo Quiz][logo-quiz-appexplorer]

- [Machines vs. Machines][machines-vs-machines], the great Tower Defense clone.

- [Match the Color][matchthecolor-appexplorer]

- [Mines][mines-appexplorer]

- [Neverball][neverball-appexplorer], a 3D physics game.

- (*NEW*) [Neverbore Picross][neverbore-appexplorer], a picture logic puzzle game

- [Neverputt][neverputt-appexplorer], a 3D minigolf game.

- [PathWind][pathwind-appexplorer], a physics-based game.

- [QVBA-M][qvba-appexplorer], a GameBoy Advance emulator.

- [QZ81][qz81-appexplorer], a ZX-81 emulator.

- [Riddling][riddling-appexplorer], solve riddles to complete each level.
...
- [Sudoku][sudoku-appexplorer]

- [Tabu][tabu-appexplorer]

- [Ubuntu Netwalk][ubuntu-netwalk-appexplorer], a clone of the Netwalk game.

- [zTTT][zttt-appexplorer], a Tic-Tac-Toe clone.

- (*NEW*) [uu][uu-appexplorer], an aa clone.
...
- [CitySim][citysim-appexpplorer], a SimCity clone
...
- (*NEW*) [Counter][counter-appexplorer], a general-purpose counter.

- [Currency Converter][currencyconverter-appexplorer]

- (*NEW*) [EdIt][edit-appexplorer], a simple text editor

- [Level][level-appexplorer], a bubble level

- [Quick Memo][quickmemo-appexplorer], a note-taking app with support for images, lists and colors.

- [Timer][timer-appexplorer], a countdown timer that works if put in the background.

- [Stopwatch][stopwatch-appexplorer]
...
-  [Socket World][socketworld-appexplorer], a list of power plugs and sockets used in different countries.
...
- [Beru][beru-appexplorer], an e-Book reader for DRM-free books in the ePub format.

- [Cantata][cantata-appexplorer], an MPD client.

- [Chancho][chancho-appexplorer], a personal finance management app.

- [Dekko][dekko-appexplorer], an e-mail client.

- [Document Viewer][documentviewer-appexplorer], a document viewer for PDFs and other file formats.

- [DowNow][downow-appexplorer], a BitTorrent client with Magnet link support and a built-in search engine frontend.

- [Funds][funds-appexplorer], another personal finance management app.

- [GPS Navigation][gpsnavigation-appexplorer], online, turn-by-turn navigation based on OpenStreetMap data.

- [Graphite Drawing][graphite-appexplorer], a natural painting app.

- [Known][known-dictionary-appexplorer], an offline dictionary.

- (*NEW*) [Kodimote][kodimote-appexplorer], a remote for Kodi.

- [Mirage][mirage-appexplorer], another painting app.

- [Network Scanner][networkscanner-appexplorer], a TCP/IP network scanner.

- [Plates][plates-appexplorer], a calorie intake tracker.
...
- (*NEW*) [Sherlock scope][sherlock-appexplorer], summarises websites.

- [Shorts][shorts-appexplorer], an RSS feed reader.

- [Tagger][tagger-appexplorer], a Barcode scanner.

- [Tasks][tasks-appexplorer] and  [Utudu][utudu-appexplorer], task management apps.

- [Telegram][telegram-appexplorer], a secure Instant Messenger.

- [uRadio][uradio-appexpplorer] and  [RadioTunes][radiotunes-appexplorer], online radio stream players.
...
- (*UPDATED*) Generic audio memo recorder, currently hindered by [bug 1467219][launchpad-bug-1467219].

- [DLNA server][dlna-server], to stream pictures/audio/video to the local network.

- (*NEW*) [Quadrum][quadrum-appexplorer], a FourSquare client.

- (*NEW*) [OSMScout][osmscout-appexplorer], a turn-by-turn navigation app with support for offline OpenStreetMap maps.
...
- WiFi scanner. There are two approaches to this: You can either install the [OpenStore][openstore] and run Michael Zanetti's [WiFi Scanner][wifiscanner-openstore], or you can wait until the connectivity-api allows the implementation of a confined [WiFi scanner]({% post_url 2015-01-30-extending-the-ubuntu-touch-connectivity-api-for-wifi-scanning %}).
...
- (*NEW*) [aroundU Scope][aroundu-appexplorer], shows nearby locations from Google Places and Yelp.

- [Cachemere][cachemere-appexplorer], find nearby Geocaches.

- [Delivery Tracker][deliverytracker-appexplorer] for all major delivery services.

- (*NEW*) [Eventful scope][eventful-appexplorer], shows events around you.
...
- [Google Plus][googleplus-appexplorer]

- [Imgur][imgur-appexplorer], an [Imgur Content Hub plugin][imgur-share-appexplorer] and an [Imgur scope][imgur-scope-appexplorer]

- (*NEW*) [PhotoFunia][photofunia-appexplorer], creates photo collages.

- [Réaltaí][realtai-appexplorer], a Google Sky Map clone.

- (*NEW*) [Seshat][seshat-appexplorer], an e-Book reader for the Amazon Kindle Cloud Reader.

- [Shine][shine-appexplorer], control your Philips Hue lights.

- [Tanken][tanken-appexplorer], gas price comparison.

- [Twitter][twitter-appexplorer] and the  [Twitter Trending Scope][twitter-scope-appexplorer].

- [Uber][uber-appexplorer], a webapp for Uber.

- [uFit][ufit], a FitBit management app.

- [uKindle][ukindle-appexplorer], another e-Book reader for Amazon Kindle.

- [uReadIt][ureadit-appexplorer], a Reddit reader.

- (*NEW*) [VK Music][vkmusic-appexplorer], a client for the VKontakte streaming service.
...
- (*NEW*) [Weather][weather-appexplorer], a weather app based on OpenWeatherMap data.
...
[dlna-server]: https://uappexplorer.com/app/upnp-present.jamesh
...
[seshat-appexplorer]: https://uappexplorer.com/app/seshat.sil

[connect4-appexplorer]: https://uappexplorer.com/app/com.ubuntu.developer.geelen-bram.connect4

[fish-fillets]: http://fillets.sourceforge.net/

[launchpad-bug-1467219]: https://bugs.launchpad.net/ubuntu/+source/media-hub/+bug/1467219

[osmscout-appexplorer]: https://uappexplorer.com/app/osmscout.fransschreuder

[quadrum-appexplorer]: https://uappexplorer.com/app/com.ubuntu.developer.turan.mahmudov.ufoursquare

[logo-quiz-appexplorer]: https://uappexplorer.com/app/logoquiz.roman2861

[weather-appexplorer]: https://uappexplorer.com/app/weather.mzanetti

[counter-appexplorer]: https://uappexplorer.com/app/counter.michael-weimann-eu

[eventful-appexplorer]: https://uappexplorer.com/app/eventfulscope.turan-mahmudov-l

[uu-appexplorer]: https://uappexplorer.com/app/uu.mzanetti

[edit-appexplorer]: https://uappexplorer.com/app/com.ubuntu.developer.pawstr.edit

[sherlock-appexplorer]: https://uappexplorer.com/app/adlegant-scope.mefrio-g

[neverbore-appexplorer]: https://uappexplorer.com/app/neverbore.mterry

[vkmusic-appexplorer]: https://uappexplorer.com/app/vkmusic.turan-mahmudov-l

[dontcrash-appexplorer]: https://uappexplorer.com/app/dontcrash.popey

[photofunia-appexplorer]: https://uappexplorer.com/app/capsuledigital.capsuledigital

[kodimote-appexplorer]: https://uappexplorer.com/app/com.ubuntu.developer.mzanetti.kodimote

[aroundu-appexplorer]: https://uappexplorer.com/app/eu.michael-weimann.unity-scope-nearby